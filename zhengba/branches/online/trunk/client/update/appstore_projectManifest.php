...
$RES = array(
	...
	#'packageUrl'=> HTTP().'/zip',
	'remoteManifestUrl' => HTTP().'/?app=appstore_projectManifest&clientver='.$VERSION,
	'remoteVersionUrl' => HTTP().'/?app=appstore_versionManifest&clientver='.$VERSION,
	'version' => ''.$VERSION,
...
function checkVersion(){
	...
	$zipName = zipName($clientVer,$VERSION,'appstore_');	
	//we($zipName);
...
function ZIP($from,$to){
	...
	$zipName = zipName($from,$to,'appstore_');
