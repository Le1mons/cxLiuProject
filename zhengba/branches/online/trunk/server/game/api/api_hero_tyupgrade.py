...
def doproc(conn, data):
    ...
    _heroList = g.m.herofun.getMyHeroList(uid, where={'_id':{'$in':tidList}},keys='zhongzu,hid,star,lv,dengjie,weardata')
    # 检查提升所需的英雄
...
if __name__ == '__main__':
    uid = g.buid("xuzhao")
    g.debugConn.uid = uid
    print doproc(g.debugConn, data=["11076",["5be4686dc0911a2a40a292ff"]])