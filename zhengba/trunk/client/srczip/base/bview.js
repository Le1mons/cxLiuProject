;(function(){
    ...
    X.viewCache = {
        ...
        releaseCache : function(target,condition){
            ...
            for(var _key in _viewCache){
                ...
                if(target==null || (condition=='equal' && _releaseKey==_key) || (condition=='like' && _key.indexOf(_releaseKey)!=-1)){
    ...
    X.initView = function (view) {
        X.forEachChild(view,function(node){
            if (node instanceof ccui.ScrollView) {
    ...
    X.bView = ccui.Layout.extend({
        ...
        fillSize : function(size){
            ...
            }else if( (cc.isNode(_parent) && !(_parent instanceof X.bScene)) || this._conf.showAll){
