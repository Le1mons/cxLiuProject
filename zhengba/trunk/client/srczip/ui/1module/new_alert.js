...
(function () {
    ...
    var fun = X.bUi.extend({
        ...
        richText: function (v) {
            ...
            var data = me.data();
           // var vip = data.vip;         //vip 等级
            var neednum = data.neednum;  //需要的物品数量
            var leftnum = data.leftnum;   //剩余需要物品的数量
            ...
            num.setString(' '+ leftnum);
            num.setTextColor(cc.color('#78ff2f'));
            num.setFontSize(24);
            num.setFontName(G.defaultFNT);
            var icon = new ccui.ImageView(G.class.getItemIco(neednum.t), 1);
            var str = X.STR(L("GMSLCS"),neednum.n);
            ...
            me.view.nodes.panel_txt.setContentSize(me.view.nodes.panel_txt.width,me.view.nodes.panel_txt.height)
            me.view.nodes.panel_txt.addChild(rh);
            me.view.nodes.panel_txt.setPositionY(190);
            me.view.nodes.panel_txt.setPositionX(me.view.nodes.panel_txt.width/2+110);
