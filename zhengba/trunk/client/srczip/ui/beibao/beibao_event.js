 ...
 */
G.event.on('itemchange',function(d,_data,formInfo){
    G.event.emit("default_itemchange",d,_data,formInfo);
    var o = X.toJSON(d);
    var tips = [];
    var type = 'item';
...
G.event.on("glyphchange", function (d,_data,formInfo) {
    G.event.emit("default_glyphchange",d,_data,formInfo);
    var o = X.toJSON(d);
...
G.event.on('equipchange',function(d, conf,formInfo){
    G.event.emit('default_equipchange', d, conf,formInfo);
    var o = X.toJSON(d);
    var tips = [];
