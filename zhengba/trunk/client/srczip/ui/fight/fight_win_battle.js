...
(function() {
    ...
    var fun = X.bUi.extend({
        ...
        onShow: function() {
            ...
            me.DATA = me.data() || G.frame.fight.data();
        ...
        setContents: function() {
            ...
            var fightData = me.data() || G.frame.fight.data().fightData || G.frame.fight.DATA;
        ...
        setGjjjc:function(left,right){
            ...
            if (me.DATA.pvType == 'pvgjjjc' || me.DATA.pvType == 'pvwz' || me.DATA.pvType == 'pvwzdld' || me.DATA.pvType == "wztt_three") {
                ...
                if(me.DATA.pvType == 'pvwz' || me.DATA.pvType == "wztt_three") {
                    left.finds('text_df').show();
                    right.finds('text_df').show();

                    var leftFen = 0;
                    var rightFen = 0;
                    var _fdata = me.DATA.pvType == 'pvwz' ? me.DATA.fightData : me.DATA.fightData.fightres;

                    for (var i = 0; i < me.DATA.session + 1; i ++) {
                        if(_fdata[i].winside == 0) leftFen ++;
                        else rightFen ++;
                    }
                    ...
                    var whoWin = _fdata[me.DATA.session].winside;
        ...
        setFlop: function () {
            ...
            if(me.DATA.flop && me.DATA.pvType != "pvgjjjc") {
