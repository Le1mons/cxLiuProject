        ...
        setContents: function () {
            ...
            X.render({
                ...
                btn_jl: function (node) {
                    node.touch(function (sender, type) {
                        if (type == ccui.Widget.TOUCH_ENDED) {
                            ...
                            me.objData.joinlv = me.nodes.txt_field.getString();
                            me.objData.auto = me.nodes.img_txgou.visible ? 1 : 0;
                ...
                txt_field: function (node) {
                    node.setString(21);
                    X.setInputIn(node, function (sender) {
                        node.setString(sender.getString());
                    });
                },
                img_txgoudi: function (node) {
                    ...
                    node.click(function () {
                        ...
                        me.nodes.img_txgou.setVisible(!me.nodes.img_txgou.visible);
                    });
                },
