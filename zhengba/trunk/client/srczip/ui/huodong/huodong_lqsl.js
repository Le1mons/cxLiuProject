...
(function () {
    //钓鱼活动
    G.class.huodong_lqsl = X.bView.extend({
        ctor: function (data) {
            var me = this;
            me._data = data;
            me._super("longqishilian.json", null, {action: true});
        },
        initUi: function () {
            var me = this;
        ...
        bindBtn: function () {
            ...
            me.nodes.btn_pmjl.click(function () {
                if (!me.DATA.rank.topdps && !me.DATA.rank.name) return G.tip_NB.show(L("TZLQSL"));
