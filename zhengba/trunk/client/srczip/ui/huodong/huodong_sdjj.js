...
(function () {
    //神殿基金
    G.class.huodong_sdjj = X.bView.extend({
        ctor: function (type) {
            var me = this;
            me._type = type;
        ...
        getType:function(){
            var me = this;
            if(me.DATA.val < G.gc.sdjj.data.shendianjijin_1.arr[G.gc.sdjj.data.shendianjijin_1.arr.length-1].val) return me.type = 'shendianjijin_1';
            var typearr = X.keysOfObject(G.gc.sdjj.data);
            for(var i = 0; i < typearr.length; i++){
                var data = G.gc.sdjj.data[typearr[i]].arr;
            ...
            if(me.DATA.val >= G.gc.sdjj.data.shendianjijin_5.arr[G.gc.sdjj.data.shendianjijin_5.arr.length-1].val) return me.type = 'shendianjijin_6';
            if(me.DATA.val >= G.gc.sdjj.data.shendianjijin_4.arr[G.gc.sdjj.data.shendianjijin_4.arr.length-1].val) return me.type = 'shendianjijin_5';
            if(me.DATA.val >= G.gc.sdjj.data.shendianjijin_3.arr[G.gc.sdjj.data.shendianjijin_3.arr.length-1].val) return me.type = 'shendianjijin_4';
            if(me.DATA.val >= G.gc.sdjj.data.shendianjijin_2.arr[G.gc.sdjj.data.shendianjijin_2.arr.length-1].val) return me.type = 'shendianjijin_3';
            if(me.DATA.val >= G.gc.sdjj.data.shendianjijin_1.arr[G.gc.sdjj.data.shendianjijin_1.arr.length-1].val) return me.type = 'shendianjijin_2';
        },
        ...
        initBtn:function(){
            var me = this;
            if(me.DATA.val >= G.gc.sdjj.data.shendianjijin_1.arr[G.gc.sdjj.data.shendianjijin_1.arr.length-1].val){
                if(!X.cacheByUid('shendianjijin_1')){
                    G.class.ani.show({
                    ...
                    X.cacheByUid('shendianjijin_1',1);
                }else {
                    me.nodes.btn_01.show();
                }
            }else {
            ...
            if(me.DATA.val >= G.gc.sdjj.data.shendianjijin_1.arr[G.gc.sdjj.data.shendianjijin_1.arr.length-1].val){
                if(!X.cacheByUid('shendianjijin_2')){
                    G.class.ani.show({
                        json: "huodong_djjj_tx",
                    ...
                    X.cacheByUid('shendianjijin_2',1);
                }else {
                    me.nodes.btn_02.show();
                }
            }else {
            ...
            if(me.DATA.val >= G.gc.sdjj.data.shendianjijin_2.arr[G.gc.sdjj.data.shendianjijin_2.arr.length-1].val){
                if(!X.cacheByUid('shendianjijin_3')){
                    G.class.ani.show({
                        json: "huodong_djjj_tx",
                    ...
                    X.cacheByUid('shendianjijin_3',1);
                }else {
                    me.nodes.btn_03.show();
                }
            }else {
            ...
            if(me.DATA.val >= G.gc.sdjj.data.shendianjijin_3.arr[G.gc.sdjj.data.shendianjijin_3.arr.length-1].val){
                if(!X.cacheByUid('shendianjijin_4')){
                    G.class.ani.show({
                        json: "huodong_djjj_tx",
                    ...
                    X.cacheByUid('shendianjijin_4',1);
                }else {
                    me.nodes.btn_04.show();
                }
            }else {
            ...
            if(me.DATA.val >= G.gc.sdjj.data.shendianjijin_4.arr[G.gc.sdjj.data.shendianjijin_4.arr.length-1].val){
                if(!X.cacheByUid('shendianjijin_5')){
                    G.class.ani.show({
                        json: "huodong_djjj_tx",
                    ...
                    X.cacheByUid('shendianjijin_5',1);
                }else {
                    me.nodes.btn_05.show();
                }
            }else {
            ...
            if(me.DATA.val >= G.gc.sdjj.data.shendianjijin_5.arr[G.gc.sdjj.data.shendianjijin_5.arr.length-1].val){
                if(!X.cacheByUid('shendianjijin_6')){
                    G.class.ani.show({
                        json: "huodong_djjj_tx",
                    ...
                    X.cacheByUid('shendianjijin_6',1);
                }else {
                    me.nodes.btn_06.show();
                }
            }else {
            ...
            me.nodes.btn_buy.click(function (sender, type) {
                ...
                G.event.once('paysuccess', function() {
                    G.frame.jiangli.data({
                        prize:G.gc.sdjj.data[me.type].prize
                    }).show();
                    me.refreshPanel();
                ...
                G.event.emit('doSDKPay', {
                    pid:me.type,
                    logicProid: me.type,
                    money: G.gc.sdjj.data[me.type].needmoney * 100,
                });
            }, 500);
        ...
        getData: function(callback){
            ...
            G.ajax.send("sdjj_open", ['sdjj'], function (d) {
                if (!d) return;
                var d = JSON.parse(d);
                if (d.s == 1) {
                    me.DATA = d.d;
        ...
        setBanner: function () {
            ...
            X.render({
                img_bg: function (node) {
                    node.setBackGroundImage('img/event/img_event_banner34.png', 0);
                }
            },me.nodes);
            X.setModel({
        ...
        setTable: function (type) {
            ...
            me.nodes.btn_txt1.setString(me.DATA[me.type].pay ? L("YGM") : G.gc.sdjj.data[me.type].needmoney + L("YUAN"));
            var scrollview = me.nodes.scrollview;
            scrollview.removeAllChildren();
            cc.enableScrollBar(scrollview);

            var data = JSON.parse(JSON.stringify(G.gc.sdjj.data[me.type].arr));
            ...
            X.render({
                ...
                btn: function (node) {
                    ...
                    node.click(function (sender, type) {
                        ...
                        G.ajax.send("sdjj_receive", ['sdjj',me.type,data.idx], function (d) {
                            if (!d) return;
                            d = JSON.parse(d);
                            if (d.s == 1) {
                                me.refreshData();
                                G.frame.jiangli.data({
                                    ...
                                    //判断是不是领的最后一个奖励
                                    var getnum = 0;
                                    for(var k in G.gc.sdjj.data){
                                        if(me.DATA[k].paid.length >= G.gc.sdjj.data[k].arr.length){
                                            getnum++;
                                        }
                                    }
                                    if(getnum == X.keysOfObject(G.gc.sdjj.data).length){
                ...
                txt1:function (node) {
                    node.setString(X.STR(L('TGDSG'),data.val));
                }
            }, ui.nodes);
            ui.show();
        }
