 ...
 (function () {
    ...
    var fun = X.bUi.extend({
                ...
                btnCs: function (node) {
                    ...
                    node.touch(function (sender, type) {
                        if (type == ccui.Widget.TOUCH_ENDED) {
                            ...
                            if (me.ownNum < me.needAttr[0].n && me.needAttr[0].t == "rmbmoney") {
        ...
        setBaseInfo: function () {
            ...
            if (!me.data().add) {
                var maxBuyNum = Math.floor(me.ownNum / me.needAttr[0].n);
                if (me.data().maxNum) {
                    maxBuyNum = maxBuyNum > me.data().maxNum ? me.data().maxNum : maxBuyNum;
                }
                me.maxNum = maxBuyNum;
            } else {
                me.maxNum = me.data().buyNum;
            }
        },
        setContents: function () {
            ...
            if (!me.data().add) {
                ...
                txtName.setTextColor(cc.color(G.gc.COLOR.n5));
                txtName.setString(me.data().str);
            }
            ...
            // if (me.data().add) {
            //     me._view.nodes.btn_2.hide();
            //     me._view.nodes.btn_1.hide();
        ...
        setMoney: function () {
            ...
            if (!me.data().add) {
                txtAttr.setString(X.fmtValue(me.ownNum) + '/' + X.fmtValue(me.needAttr[0].n * me.curNum));
            } else {
                var need = 0;
                for (var i = me.data().buyIndex; i < me.data().buyIndex + me.curNum; i ++) {
                    need += me.data().buyConf[i][0].n;
                }
                txtAttr.setString(X.fmtValue(me.ownNum) + '/' + X.fmtValue(need));
            }
        },
        setBtns: function () {
            var me = this;
            ...
            if (me.curNum != 1) btnPlus.setEnableState(true);
            if (me.curNum < me.maxNum) btnAdd.setEnableState(true);
