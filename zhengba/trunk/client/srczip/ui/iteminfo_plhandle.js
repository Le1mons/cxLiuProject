                        ...
                        if (type == ccui.Widget.TOUCH_ENDED) {
                            ...
                            G.ajax.send('item_use',[sender.itemid,me.csNum],function(d) {
                                ...
                                if(d.s == 1) {
                                    ...
                                    if (G.class.getItem(sender.itemid) && G.class.getItem(sender.itemid).usetype == 11) {
                                        G.tip_NB.show(L("JH") + L("SUCCESS"));
                                    }
                                    if (G.class.getItem(sender.itemid) && G.class.getItem(sender.itemid).usetype == 13) {
                                        G.tip_NB.show(L("JH") + G.class.getItem(sender.itemid).name + L("SUCCESS"));
                ...
                btnCs: function (node) {
                    ...
                    node.touch(function (sender, type) {
                        if (type == ccui.Widget.TOUCH_ENDED) {
                            ...
                            if(keys.length + me.csNum > G.DATA.heroCell.maxnum && me.DATA.usetype == "12"){
                                G.frame.alert.data({
                                    sizeType: 3,
                                    cancelCall: null,
                                    okCall: function () {
