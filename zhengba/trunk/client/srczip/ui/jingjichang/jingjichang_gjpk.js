    ...
    G.class.jingjichang_gjpk = X.bView.extend({
        ...
        setDjs: function() {
            ...
            if (G.time > zeroTime + openDuration) {
                ...
                txtTimeStr1.setString(L('OPEN_TO_SHOW') + '：');
        ...
        setMyRank: function() {
            ...
            layIco.addChild(wid);
            var rank = me.rank = data.myrank || 0;
                        ...
                        callback: function(node) {
                            ...
                            G.ajax.send("championtrial_fight", [sender.data.headdata.uid, data], function(d) {
                                ...
                                if (d.s == 1) {
                                    ...
                                    if(d.d.fightres.length < 1) {
                                        d.d.pvType = "pvgjjjc";
                                        d.d.session = 0;
                                        d.d.fightlength = 1;
                                        G.frame.fight.DATA = d.d;
                                        ...
                                        G.frame.fight.data({
                                            ...
                                            G.frame.fight.pvp_start({
                                                ...
                                                rList: G.frame.fight.getHidBySide(d.d.fightres, 1, true),
                                                lList: G.frame.fight.getHidBySide(d.d.fightres, 0, true),
                                                type: 'guanjunshilian'
                                            });
                                            ...
                                            G.frame.fight.pvp_end({
                                                ...
                                                result: d.d.win_uid == P.gud.uid ? 0 : 1,
                                                type: 'guanjunshilian'
                                            });
                                        }).demo(d.d.fightres[0]);
                                        if(d.d.fightres[0].winside == 0){
                                            G.event.emit('sdkevent',{
                                                event:'jjc_shilianjj',
                                                data:{
                                                    waiyu_rank:me.rank,
                                                    waiyu_score:me.jifen,
                                                    get:d.d.flop.prize,
                                                }
                                            });
                                        }
