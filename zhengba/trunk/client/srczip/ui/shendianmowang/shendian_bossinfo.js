G.class.bossInfo = function (type, id, con) {
    var conf = {};
    var img;
    ...
    if (con) {
        conf = JSON.parse(JSON.stringify(con));
        conf.conf = con;
        conf.title = con.title;
        img = "ico/skillico/" + conf.ico + ".png";
    }
...
(function () {
    ...
    var fun = X.bUi.extend({
        ...
        initUi: function () {
            ...
            me.nodes.name.setString(me.DATA.title || me.DATA.conf.name);
        },
        bindBtn: function () {
            var me = this;
