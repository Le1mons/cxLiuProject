    ...
    var fun = X.bUi.extend({
        ...
        setContents: function () {
            ...
            if(P.gud.artifact >= me.curId) {
                ...
                me.nodes.panel_hx1.finds("txt_sz1$").setString(L("QUANDUI") + L("atk") + "+" + G.class.shenqi.getBuffByIdAndLv(me.curId, 1).buff.atk);
                me.ui.finds("panel_hx1$_0").finds("txt_sz1$").setString(L("QUANDUI") + L("hp") + "+" + G.class.shenqi.getBuffByIdAndLv(me.curId, 1).buff.hp);
            }else {
                    ...
                    if(me.curId == 5) {
                        ...
                        G.frame.jiangli.once("hide", function () {
                            G.class.ani.show({
                                ...
                                onend: function () {
                                    if(me.curId == 1) G.guide.show(160);
                                }
                            });
                        });
                    }
        ...
        setItem: function (conf, data, index, idx) {
            ...
            X.alignItems(list.finds("ico"), conf.prize, "left", {
                touch: true,
                scale: .7
            });
