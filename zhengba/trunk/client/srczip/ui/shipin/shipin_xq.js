    ...
    var fun = X.bUi.extend({
        ...
        onShow: function () {
            ...
            new X.bView('zhuangbei_tip1.json', function (view) {
                ...
                me.setContents(view,true, me.curId);
            ...
            if (me.state == 'tihuan') {
                new X.bView('zhuangbei_tip1.json', function (view) {
                    ...
                    me.ui.nodes.panel_nr.addChild(view);
                    me.setContents(view,false, curXBid);
                    view.setTouchEnabled(true);
                });
            }
        },
        ...
        setContents: function (panel,bool,spid) {
            var me = this;

            panel.nodes.panel_bg.setTouchEnabled(true);
            panel.nodes.panel_bg.setSwallowTouches(true);

            me.setTop(panel,bool,spid);
            me.setBtns(panel,bool);
        },
        setTop: function (panel,bool,spid) {
            var me = this;
            ...
            if (me.state == 'xiexia' && me.conf.back && me.conf.back.prize.length > 0) {
            ...
            if (spid && G.gc.shipincom.awake.skillList[spid.split("_")[1]]) {
                str += '<br>' + G.gc.shipincom.awake.skillList[spid.split("_")[1]].intr;
            }
            str += '<br><font size=20>' + ' ' + '</font>';
            rh.text(str);
            ...
            if (me.state == 'tihuan') {
                if (bool) {
                    panel.nodes.panel_bg.y = panel.nodes.panel_bg.y + panel.nodes.panel_bg.height / 2 + offsetY / 2 + 5 - 70;
                    ...
                    panel.nodes.panel_bg.y = panel.nodes.panel_bg.y - panel.nodes.panel_bg.height / 2 - offsetY / 2 - 30 - 70;
