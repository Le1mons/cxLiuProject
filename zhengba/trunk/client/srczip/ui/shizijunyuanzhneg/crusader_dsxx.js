    ...
    var fun = X.bUi.extend({
        ...
        setContents: function () {
            ...
            for(var i in enemyConf){
                ...
                if (conf.pos == 7) continue;
                arr.push(list);
            }
            X.center(arr, me.nodes.panel_ico1, {
                scale: .7
            });
            X.alignCenter(me.nodes.panel_ico2, G.class.shizijunyuanzheng.getConf().base.passprize[me.DATA.difficult][me.DATA.idx.toString()], {
                name: "",
                touch: true,
                scale: .8,
                callback: function () {
