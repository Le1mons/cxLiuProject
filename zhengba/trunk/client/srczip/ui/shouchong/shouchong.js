...
(function () {
    ...
    var fun = X.bUi.extend({
        ...
        setContents: function () {
            ...
            var isFinish = true;
            me.nodes.btn_shouchong_qcz.removeAllChildren();
            me.nodes.btn_shouchong_lq.removeAllChildren();
            ...
            G.class.ani.show({
                ...
                onload: function (node, action) {
                    var hid_arr = ['newniutou', 'newniutou', 'newniutou'];
                    ...
                    X.setHeroModel({
                        ...
                        model: hid_arr[me.type - 1],
                    });
                    rw.setAnchorPoint(0.5, 0.4);
                    // rw.setFlippedX(true);
                    rw.setScale(1);
            ...
            if (me.DATA.paynum < conf.paynum) {
                ...
                G.class.ani.show({
                    ...
                    addTo: me.nodes.btn_shouchong_qcz,
                    repeat: true,
                    autoRemove: false,
                    onload: function (node, action) {
                        node.setTag(777777);
                ...
                if (me.typeData.rec.length == conf.prize.length || G.time < me.typeData.chkrectime[idx]) {
                    ...
                    G.class.ani.show({
                        ...
                        addTo: me.nodes.btn_shouchong_lq,
            ...
            me.nodes.btn_shouchong_qcz.click(function (sender, type) {
                if((G.OPENTIME + X.getOpenTimeToNight(G.OPENTIME)+60*60*24*6) < G.time){
                    G.frame.chongzhi.data({'type':2}).show();
                }else{
                    G.frame.huodong.data({idx:4,type:0,stype:10056}).show();
                }
