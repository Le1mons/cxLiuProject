    ...
    var fun = X.bUi.extend({
        ...
        bindUI: function () {
            ...
            me.btnTz.touch(function (sender, type) {
                if (type === ccui.Widget.TOUCH_ENDED) {
                    if (me.DATA.myinfo.remainnum < 1) return G.tip_NB.show(L("TZCSBZ"));
        ...
        setBottom: function () {
            ...
            if(!data.myinfo.refrash) {
                ...
                txtSyNum.setTextColor(cc.color("#ff4e4e"));
                X.enableOutline(txtSyNum, "#680000", 2);
