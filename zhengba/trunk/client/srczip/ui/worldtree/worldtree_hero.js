...
(function () {
    ...
    G.class.worldtree_hero = X.bView.extend({
        ...
        getData: function(callback) {
            ...
            me.ajax("worldtree_open", [], function (str, data) {
                if(data.s == 1) {
                    me.cache = data.d;
                    if (data.d.tid) {
                        me.cacheTid = data.d.tid;
                        me.selectedData = data.d.tid;
                    }
                    callback && callback();
                }
            });
        ...
        setContents: function () {
            ...
            if(G.DATA.yingxiong.list[me.cacheTid] && me.cache.swap) {
                ...
                me.willGetData = {a: 'hero', t: me.cache.swap, n: 1};
                me.setAttr(G.DATA.yingxiong.list[me.cacheTid].star);
            } else {
                me._view.show();
            }
        ...
        setItem_hero: function (item) {
            ...
            if (item.data) {
                ...
                G.class.hero.getSoundByHid(item.data.t);
            } else {
                var conf = G.class.hero.getById(heroData.hid);
                //设置英雄模型
                X.setHeroModel({parent: layHero, data: heroData});
                G.class.hero.getSoundByHid(heroData.hid);
            }
        ...
        setBaseInfo: function () {
            ...
            me.btnZh.data = [];
            me.btnZh.click(function (sender, type) {
                ...
                G.ajax.send('worldtree_swap',[me.selectedData],function(d) {
                    ...
                    if(d.s == 1) {
                        G.event.emit("sdkevent", {
                            event: "zhzs_zhuanhuan",
                            data:{
                                zhaohuan_zhenying:me.selectedData,
                                consume:me.need,
                            }
                        });
                        X.cacheByUid("swapHeroTid", me.selectedData);
            ...
            me.btnQx.click(function () {
                ...
                me.ajax("worldtree_del", []);
            }, 800);
            me.btnBc.click(function () {
