...
(function () {
    ...
    var fun = X.bUi.extend({
        ...
        setTop: function () {
            ...
            if (!me.top) {
                me.top = new G.class.xstd_xuanze("fight");
        ...
        setBottom: function () {
            ...
            if (!me.bottom) {
                me.bottom = new G.class.xstd_kz('fight');
        ...
        playAniMove: function (node) {
            var me = this;
            me.mask.show();
            var posSz = G.frame.xstd_fightRead.posSz;
            var posSelect = G.frame.xstd_fightRead.posSelect;
            var type = G.frame.xstd_fightRead.playAniType;
