    ...
    var fun = X.bUi.extend({
        ...
        bindBtn: function () {
            ...
            me.nodes.btn_qw.click(function () {
                ...
                if (str.length > 0 && str1.length < 1 && str != ' ') return G.tip_NB.show(L("BZNAME"));

                X.cacheByUid("hero_remarks" + G.frame.yingxiong_xxxx.curXbId, str1);
        ...
        onShow: function () {
            var me = this;
            var heroTid = G.frame.yingxiong_xxxx.curXbId;

            me.nodes.text_2.setString(X.cacheByUid("hero_remarks" + heroTid) || "");
