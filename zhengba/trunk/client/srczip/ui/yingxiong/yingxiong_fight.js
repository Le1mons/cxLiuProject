...
(function () {
    ...
    var fun = X.bUi.extend({
        ...
        initUi: function () {
            ...
            if(me.DATA.zz) {
                setPanelTitle(me.ui.nodes.txt_title, L("zhongzu_" + me.DATA.zz[0]) + L("HE") + L("zhongzu_" + me.DATA.zz[1]));
            } else if (me.DATA.title) {
                setPanelTitle(me.ui.nodes.txt_title, me.DATA.title);
            } else {
        ...
        onShow: function () {
            ...
            me.DATA = me.data();
            me.isHelp = X.inArray(G.class.yingxiong_kaizhan.prototype.extConf.showHelp, me.DATA.pvType);
            me.initUi();
            me.setContents();
