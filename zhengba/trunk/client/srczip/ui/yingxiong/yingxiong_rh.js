    ...
    G.class.yingxiong_yxrh = X.bView.extend({
        ...
        setContents: function () {
            ...
            me.nodes.btn_sx.click(function () {
                if(!data.extbuff.meltsoul || X.keysOfObject(data.extbuff.meltsoul).length < 1) return G.tip_NB.show(L("SWRH"));

                if(P.gud.rmbmoney < G.gc.meltsoulcom.base.recast_cost[0].n) return G.tip_NB.show(L("ZSBZ"));

                G.frame.reset.data({
                    needNum: G.gc.meltsoulcom.base.recast_cost[0].n,
                    str: L("CZRH"),
                    callback: function () {
                        me.ajax("hero_msrecast", [me.curXbId], function (str, data) {
                            if(data.s == 1) {
                                ...
                                if(data.d.prize) {
                                    ...
                                    me.refreshPanel();
                                    G.frame.yingxiong_xxxx.rw.setPower();
                                }
                            }
                        });
                    }
            ...
            if (G.class.herostarup.getById(me.hero_hid)) {
                if (G.class.herostarup.getByIdAndDengjie(me.hero_hid, arr_tplv.length)) {
                    var starup = G.class.herostarup.getByIdAndDengjie(me.hero_hid, arr_tplv.length);
            ...
            num1.setString((dq_atk || 0) + "/" + max_atk);
            me.setQiuani(qiu2, dengjie, dq_hp, max_hp, 2);
            num2.setString((dq_hp || 0) + "/" + max_hp);
            me.tupo = false;
        ...
        setRonghun: function() {
            ...
            var img_xh2 = me.ui.finds("token_2");
            ...
            img_xh1.data = xiaohao[0];
            img_xh2.data = xiaohao[1];
            if(xiaohao){
                var color1 = G.class.getOwnNum(xiaohao[0].t, xiaohao[0].a) < xiaohao[0].n * me.quantity;
                var color2 = G.class.getOwnNum(xiaohao[1].t, xiaohao[1].a) < xiaohao[1].n * me.quantity;
            ...
            bg_gou.touch(function(sender, type) {
                if (type == ccui.Widget.TOUCH_ENDED) {
                    ...
                    for(var i=0;i<item_num.length;i++){
                        ...
                        var color = G.class.getOwnNum(xiaohao[i].t, xiaohao[i].a) < xiaohao[i].n * me.quantity;
                    ...
                    G.ajax.send("hero_meltsoul", [me.qiu_type, me.curXbId, me.quantity], function(d) {
                        ...
                        if (d.s == 1) {
                            if (d.d.hero && d.d.hero[me.curXbId]) {
                                ...
                                G.frame.yingxiong_xxxx.rw.setPower();
                                if (me.DATA.meltsoul>=8){
                                    G.frame.yingxiong_xxxx.setMeltSoulAwake();
                                }
            ...
            btn_rh.touch(function(sender, type) {
        ...
        setTupo: function(type, dq_tplv) {
            ...
            if (type == "1") {
                ...
                text = X.STR(L('YXRH_TP3'), dq_tplv,
                    "<font color=#fe6f1d" + " onclick=G.frame.yingxiong_xxxx.ui.finds('menuBtn4').triggerTouch(ccui.Widget.TOUCH_ENDED)>" + L('YXXX_YXSX') + "</font>");
            } else if (type == "4") {
                text = L('YXRH_TP4');
            }else{
                text = L('YXRH_TP5');
            ...
            rh.setPosition(0, tp_tishi.height/2 + rh.trueHeight()/2);
        ...
        setUPani:function(data, beishu, callback){
            ...
            if(beishu > 1){
                G.class.ani.show({
                    json: beishu > 2 ? "ani_ronghun_baoji3" : "ani_ronghun_baoji2",
                    addTo: up,
                    x: up.width / 2,
                    y: up.height / 2 + 60,
                    repeat: false,
        ...
        setQiuani: function(panel, type, dq, max, id) {
            var me = this;
            var color_arr = ["bai","lv","lan","zi","cheng","hong","hong","hong","hong"];
        ...
        bindBTN: function () {
            ...
            me.ui.finds('token_1').setTouchEnabled(true);
            me.ui.finds('token_2').setTouchEnabled(true);
            me.ui.finds('token_1').click(function (sender) {
            ...
            me.ui.finds('token_2').click(function (sender) {
                G.frame.iteminfo.data({
                    data: {
                        a: sender.data.a,
                        t: sender.data.t
