        ...
        var id2obj = {
            1:{
                ...
                toframe: function (data,isOwn) {
                    if (!isOwn) {
                        G.frame.zhuangbei_zbxz.data(data).show({showfm: 1});
                    } else {
                        G.frame.zhuangbei_xq.data({id:data,state:'xiexia',showfm: 1}).show();
                    }
                }
            }, //武器
            2:{
                ...
                toframe: function (data,isOwn) {
                    if (!isOwn) {
                        G.frame.zhuangbei_zbxz.data(data).show({showfm: 3});
                    } else {
                        G.frame.zhuangbei_xq.data({id:data,state:'xiexia',showfm: 3}).show();
                    }
                }
            }, //头盔
            3:{
                ...
                toframe: function (data,isOwn) {
                    if (!isOwn) {
                        G.frame.zhuangbei_zbxz.data(data).show({showfm: 2});
                    } else {
                        G.frame.zhuangbei_xq.data({id:data,state:'xiexia', showfm: 2}).show();
                    }
                }
            }, //戒指
            5:{
                ...
                toframe: function (data,isOwn) {
                    if (!isOwn) {
                        G.frame.zhuangbei_zbxz.data(data).show({showfm: 4});
                    } else {
                        G.frame.zhuangbei_xq.data({id:data,state:'xiexia',showfm: 4}).show();
                    }
                }
            }, //胸甲
            4:{
            ...
            6:{
                ...
                toframe: function (data,isOwn) {
                    if (!isOwn) {
                        ...
                        var conf = G.gc.shipin[data];
                        if (conf.color == 5 && conf.star == 6) {
                            G.frame.shipin_jx.data({
                                spid: data,
                                state: 'xiexia'
                            }).show();
                        } else {
