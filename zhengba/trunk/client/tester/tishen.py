...
def fixResAndStart ():
    ...
    for path in fileListArr:
        ...
        index+=1
    '''
    os.system('MKLINK /j "res" "../res"')
    os.system('MKLINK /j "csb" "../csb"')
...
def linkTiShen (folder):
    try:
        os.system('rmdir res2')
        os.system('rmdir csb2')
    except:
        pass
    os.system('MKLINK /j "res2" "../tishen/{}/res2"'.format(folder))
    os.system('MKLINK /j "csb2" "../tishen/{}/csb2"'.format(folder))
...
def start ():
    ...
    print '输入想加载的提审版资源文件夹名：'.decode('utf-8').encode('gbk')
    val = raw_input()
    try:
        os.system('rmdir res')
        os.system('rmdir csb')
    ...
    linkTiShen(val)
    shutil.copyfile('main_tishen.js','main.js')
