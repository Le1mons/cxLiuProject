...
def proc(conn, data):
    ...
    :param conn:
    :param data: [对方uid:str, 哪轮比赛:int(7-决赛，6-半决赛，5-四分之一决赛...)]
    :return:
    ::

        {'d': {'fightuser': {showtime:显示时间,winuid:胜者uid,fid:日志的tid},
                'winlog': {showtime:显示时间,winarr:[左边胜场数,右边胜场数],winuid:胜者uid,fighruser:[双方uid],fid:日志的tid}}
        's': 1}
