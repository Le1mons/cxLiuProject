...
def doproc(conn, data):
    ...
    _emailInfo = g.m.emailfun.getEmailInfo(eid, "_id,uid,prize,getprize,plist,title,ctime")
    ...
    # 获得奖励
    if _r['n']==1:
        _prize = g.getPrizeRes(uid, _emailInfo["prize"], {'act':"EMAIL",'tid':eid,'type':_emailInfo['title']})
