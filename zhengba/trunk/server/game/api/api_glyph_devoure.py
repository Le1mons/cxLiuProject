...
def proc(conn, data):
    ...
    :param conn:
    :param data: [雕纹的tid:str, 被吞噬的雕纹gid:str, 要吞噬的属性:str('buff','extbuff','extskill')]
    :return:
    ::
...
def doproc(conn, data):
    ...
    # 不能吞噬正在使用的雕纹
    if 'isuse' in _dGlyph or _dGlyph.get('lock'):
        _res['s'] = -4
...
if __name__ == '__main__':
    uid = g.buid("lsq666")
    g.debugConn.uid = uid
    print doproc(g.debugConn, data=["5c8798ece13823358bac209c","5c8798ebe13823358bac207b",["extskill"]])