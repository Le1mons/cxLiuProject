...
def _checkCond(uid, data):
    ...
    _con = g.m.midautumn2fun.getCon()['task'][_taskID]
    _data = g.m.midautumn2fun.getData(uid, _hd['hdid'], keys='task,val')
    # 任务没有完成
...
def doproc(conn, data):
    ...
    _send = g.getPrizeRes(uid, _prize, {'act': 'midautumn2_recieve', 'taskid':_taskID})
