...
def _checkCond(uid, data):
    ...
    _hd = g.m.huodongfun.getHDinfoByHtype(82,ttype="etime")
    # 活动还没开
    _nt = g.C.NOW()
    ...
    _con = g.m.newyear3fun.getCon()['task'][_taskID]
...
def doproc(conn, data):
    ...
    _send = g.getPrizeRes(uid, _prize, {'act': 'newyear3_recieve', 'taskid':_taskID})
