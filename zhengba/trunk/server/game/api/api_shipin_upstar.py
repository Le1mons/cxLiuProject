...
def doproc(conn, data):
    ...
    if spid.find('_') != -1:
        _upid = '{}_{}'.format(_shipinCon['upid'], spid.split('_')[1])
    else:
    ...
    _delInfo = g.delNeed(uid, _delItemList, issend=0,logdata={'act': 'shipin_upstar','id': _upid,'chives':_needList})
...
if __name__ == '__main__':
    uid = g.buid("xuzhao")
    g.debugConn.uid = uid
    data = ["5fe312b5ae6c8c110d951796",{"610602_10000084":1,'610602':1}]
