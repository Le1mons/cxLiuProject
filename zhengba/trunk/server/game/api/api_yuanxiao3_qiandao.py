...
def doproc(conn, data):
    ...
    # 设置任务领奖
    g.m.yuanxiao3fun.setData(uid, _chkData['hdid'], {'qiandao': _data["qiandao"]})

    _send = g.getPrizeRes(uid, _prize, {'act': 'yuanxiao3_qiandao', 'idx':  _idx})
